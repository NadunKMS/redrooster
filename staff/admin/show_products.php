...
<head>
    ...
    <title>PRODUCTS | Redrooster</title>
        ...
        <table class="font-redhat border-gray-50 rounded-2xl min-w-full pt-2 mt-8 bg-white border-2 divide-y-2 divide-gray-200 shadow-md">
            <thead class="ltr:text-left rtl:text-right">
                <tr>
                    ...
                    <th class="whitespace-nowrap font-lexend px-4 py-2 font-semibold text-gray-900">Product Name</th>
                    <th class="whitespace-nowrap font-lexend px-4 py-2 font-semibold text-gray-900">Category</th>
                    <th class="whitespace-nowrap font-lexend px-4 py-2 font-semibold text-gray-900">Price</th>
                    <th class="whitespace-nowrap font-lexend px-4 py-2 font-semibold text-gray-900">Quantity</th>
                    <th class="whitespace-nowrap font-lexend px-4 py-2 font-semibold text-gray-900">COD</th>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                ?>
                    <tr>
                        <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900"><?php echo $row['pid']; ?></td>
                        ...
                        <td class="whitespace-nowrap px-4 py-2 text-gray-700"><?php echo $row['price']; ?></td>
                        <td class="whitespace-nowrap px-4 py-2 text-gray-700"><?php echo $row['qty']; ?></td>
                        <td class="whitespace-nowrap px-4 py-2 text-gray-700"><?php echo $row['COD']; ?></td>
                        <td class="whitespace-nowrap px-4 py-2">
                            <a href="../../public/images/uploads/<?php echo $row['image'] ?>" target="_blank" class="hover:bg-primary_hover bg-primary inline-block px-4 py-2 text-xs font-medium text-white rounded">
                                View
                            </a>
                        </td>
                        <td class="whitespace-nowrap px-4 py-2">
                           <a href="edit_product.php?pid=<?php echo $row['pid']; ?>" class="hover:bg-primary hover:text-white text-primary border-primary inline-block px-4 py-2 text-xs font-medium border-2 rounded">
                             Edit
                             </a>
                        </td>
                    </tr>
