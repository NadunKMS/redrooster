...
<body class="font-redhat bg-orange-50/50">
    ...
    <nav class="bg-white shadow-sm">
        <div data-aos="fade-up" class="px-4 mx-auto">
            <div class="md:py-6 flex items-center justify-between px-4 py-2">
                ...
                <div class="md:flex items-center hidden space-x-4">
                    <a href="#" class="nav-active">Explore</a>
     ...
     <!-- Swiper sliders -->
    <div data-aos="fade-down" class="swiper">
    <div class="swiper-wrapper">
      <div class="swiper-slide md:px-32 sm:px-8 px-4">
        <a href=""><img src="images/cover_01.webp" alt="cover-01" class="rounded-3xl md:w-full md:h-full md:object-cover hover:shadow-lg"></a>
      </div>
      <div class="swiper-slide md:px-32 sm:px-8 px-4">
        <a href=""><img src="images/cover_02.webp" alt="cover-02" class="rounded-3xl md:w-full md:h-full md:object-cover hover:shadow-lg"></a>
      </div>
      <div class="swiper-slide md:px-32 sm:px-8 px-4">
        <a href=""><img src="images/cover_03.webp" alt="cover-03" class="rounded-3xl md:w-full md:h-full md:object-cover hover:shadow-lg"></a>
      </div>
    </div>

    <!-- Food Items Section -->
<section data-aos="zoom-in-down" class="md:mt-32 mt-16">

  <div class="flex flex-row justify-between">
    <h1 data-aos="fade-right" class="md:text-4xl font-lexend text-2xl font-bold">Today's Top Picks for You</h1>
